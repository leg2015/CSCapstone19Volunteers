...
async function geocode(addressStr) {
  await axios.get('https://maps.googleapis.com/maps/api/geocode/json?', {
    params: {
      address: addressStr,
      key: 'AIzaSyDXKsysbYwfZ89T85u9Na24a0wlUMG7Txg' // TODO: !!! HIDE THIS KEY BEFORE DISTRIBUTION BUILD !!!
    }
  }).then(response => {
    // log full response
...
$('#howToButton').on("click", function() {
  ...
  '<video width="450" height="300" controls> <source src="/static/images/HowToSearchInitialVideo.mp4" type="video/mp4"> Your browser does not support the video tag. </video>',
